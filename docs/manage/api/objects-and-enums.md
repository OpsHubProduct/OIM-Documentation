...
Below are the objects schema details for the different available resources of <code class="expression">space.vars.OIM</code>.  
...
| **Name** | **Type** | **Description**                                                                            |
|----------|----------|---------------------------------------------------------------------------------------------|
| key      | String   | Unique key for each configuration for the system in <code class="expression">space.vars.OIM</code>             |
...
| **Value**        | **Description**                                                       |
|------------------|------------------------------------------------------------------------|
| CREATE_FAILURE   | It will create processing failure in <code class="expression">space.vars.OIM</code>       |
