...
* Following are the types of **Purge** provided:
  ...
  * **Integrated Data Records**: It enables users to purge integrated data records from the <code class="expression">space.vars.OIM</code> database. Refer to the [Purge Integrated Data Records](purge-records.md#purge-integrated-data-records) section for more details.
...
* All purged records are automatically saved as CSV files in the <code class="expression">space.vars.OIM</code> installation directory:
