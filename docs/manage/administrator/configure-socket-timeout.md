- Socket Timeout is the amount of time for which <code class="expression">space.vars.SITENAME</code> will wait for an API response after making an API request.
