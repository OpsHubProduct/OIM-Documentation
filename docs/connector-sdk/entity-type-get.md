  ...
  "links": {
    ...
    "linkTypes": [

      {
        ...
        "linkType": "Parent. It indicates how source entity is linked with target entity.",
        ...
        "reverseLinkType": "Child. It indicates how target entity is linked with source entity.",
...
|                  | linkTypeDirection | False | Enum    | Applicable only if the end system supports directional links.<br><br> Possible values:<br>1) FORWARD: When the link originates from the current entity. <br>2) BACKWARD: When the link points the current entity.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |   
