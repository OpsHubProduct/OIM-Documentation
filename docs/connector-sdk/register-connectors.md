...
There is an audit icon <img src="../assets/AuditsIcon.png" width="25"/> present on the top right corner of the list. Clicking this icon will show all the audits related to the registered connectors.
