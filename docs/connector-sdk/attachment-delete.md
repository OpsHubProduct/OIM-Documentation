...
| attachmentType | query | False    | String | Name of the field from which the attachment needs to be deleted.<br>For example, if the attachment needs to be deleted from 'Steps' field,<br>attachmentType="Steps"                                              |
| typeItemId     | query | False    | String | Id of the item within the field from which the attachment needs to be deleted.<br>For example, if the attachment needs to be deleted from step 1 of 'Steps' field, provide id of step 1,<br>typeItemId="10409526" |
