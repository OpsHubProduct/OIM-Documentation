...
# Description
<code class="expression">space.vars.OIM</code> supports a polling mechanism for retrieving data from source systems. The polling mechanism can be categorized based on the richness of the end system's API.

# Category of Read Mechanism
<code class="expression">space.vars.OIM</code> supports 3 types of Reading Mechanism Techniques.
