...
3. Create a failure. This is a default option. Identify such failures in <code class="expression">space.vars.OIM</code>and then delete the failures manually. To manage failure, refer [Manage Integration Failures](../../troubleshooting/manage-integration-failures.md). Please make a note that once you delete such failure from <code class="expression">space.vars.OIM</code>, if any update comes on system A after some time, then it will again generate a failure.  
