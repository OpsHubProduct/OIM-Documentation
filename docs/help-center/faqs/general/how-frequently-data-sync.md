...
If I create a new integration, then how frequently data is read from the source system and synchronized to the target system? In <code class="expression">space.vars.OIM</code>, this is referred as schedule of the integration. What will be the default schedule when a new integration is created?

## Solution

The default schedule will depend on the <code class="expression">space.vars.OIM</code> edition you have.
