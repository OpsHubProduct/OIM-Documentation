...
* In <code class="expression">space.vars.OIM</code>, the OHMT_EAI_ENTITY_HISTORY_STATE table contains more storage than its utilization. Hence, compression can be applied here if the table size is too large at your end.
