...
Service URL is a mandatory field during system configuration that is used to provide OpsHubTFSService URL. <code class="expression">space.vars.OIM</code> requires OpsHubTFSService to communicate with Team Foundation Server (TFS) and Azure DevOps.  

Refer [Why <code class="expression">space.vars.OIM</code> needs OpsHubTFSService?](purpose-of-opshubtfsservice.md) section to learn more about OpsHubTFSService.  
