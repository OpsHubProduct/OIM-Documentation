...
>**Note**: To know how to map comments in <code class="expression">space.vars.OIM</code>, please refer mapping [Comments](../../../integrate/mapping-configuration.md#comments) in the documentation.
