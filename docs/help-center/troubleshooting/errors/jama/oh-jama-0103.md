...
- With respect to the above end system behavior, when any update comes on **Set** entity field **Child Item Type**, <code class="expression">space.vars.OIM</code> will raise this error.
