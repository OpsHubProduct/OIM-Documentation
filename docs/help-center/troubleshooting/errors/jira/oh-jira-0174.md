...
## Cause
This error could come up when there is an issue with your Jira instance or <code class="expression">space.vars.OIM</code> mapping configuration. Refer [Need for handling workflow transition in Jira](../../../../connectors/jira.md#need-for-handling-workflow-transition) for understanding the cases in which this error can occur.
