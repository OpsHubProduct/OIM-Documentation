...
* The OpsHubTFSService has not been upgraded after upgrading <code class="expression">space.vars.OIM</code>.
...
* If you have upgraded <code class="expression">space.vars.OIM</code>, then refer [How to upgrade OpsHubTFSService after upgrading <code class="expression">space.vars.OIM</code>?](../../../faqs/tfs/how-to-upgrade-opshubtfsservice-after-upgrading-opshub-integration-manager.md) to upgrade OpsHubTFSService.
