...
>**Note**: This option will start skipping the attachments from all the systems for which <code class="expression">space.vars.OIM</code> can determine the attachments which are not found.
