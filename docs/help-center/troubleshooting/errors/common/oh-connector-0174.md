...
No actions required.  
This is a temporary error and it will be automatically resolved in the next execution run. In the next execution run, <code class="expression">space.vars.OIM</code> will create a new entity on system B with proper data and this fail event will be resolved.
