...
*This issue occurs when upgrading <code class="expression">space.vars.OIM</code> to version 7.78 or higher. It throws event failure as the query filters format is changed.*  
