...
|---------------------------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| `hostName`                | Name or IP of the host where <code class="expression">space.vars.OIM</code> is installed         | localhost                                                                       |
| `commitUrlPath`           | Commit URL for SCM system used to redirect user to the SCM system            | https://github.com/docker/compose/commit                                        |
| `authentication`          | Authentication password salt for <code class="expression">space.vars.OIM</code> login            | Basic YWRtaW46cGFzc3dvcmQ=                                                      |
...
## Install and setup <code class="expression">space.vars.OIM</code>, Cube and Superset
...
* On completion, the script will start showing logs of <code class="expression">space.vars.OIM</code>. To halt, press `Ctrl+C`.  
...
## Upgrade <code class="expression">space.vars.OIM</code> Application Version
