...
- First, install **<code class="expression">space.vars.OIM</code>**.  
- Then, configure Jama and TestRail onto **<code class="expression">space.vars.OIM</code>**.  
...
**Notes:**  
- Section is a mandatory entity in TestRail system to create a Test Case. In Jama → TestRail integration, as per **<code class="expression">space.vars.OIM</code>**'s modeling structure, one pre-defined section is mapped for default mapping.  
