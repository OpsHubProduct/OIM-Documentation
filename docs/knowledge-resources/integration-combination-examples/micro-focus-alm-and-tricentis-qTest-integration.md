...
<code class="expression">space.vars.OIM</code> integrates Micro Focus ALM and Tricentis qTest bi-directionally. On this page, we will discuss the bi-directional integration of:  
...
For example, here we select <code class="expression">space.vars.OIM</code> Demo Project from Tricentis qTest and TestProject from Micro Focus ALM.  
...
* <code class="expression">space.vars.OIM</code> fetches entities available in both systems and shows them in the entities list for both systems.  
...
Even if you select **Auto Map**, <code class="expression">space.vars.OIM</code> will allow you to remove or add more fields before saving mapping.  
