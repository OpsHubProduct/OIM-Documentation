...
<code class="expression">space.vars.OIM</code> integrates Micro Focus ALM and Jira bi-directionally. On this page, we will discuss the bi-directional integration of:
...
* In the Add Project(s) to Sync section, select the projects you want to synchronize between Jira and Micro Focus ALM by clicking them. For example, here we select <code class="expression">space.vars.OIM</code> Demo Project from Jira and TestProject from Micro Focus ALM.  
