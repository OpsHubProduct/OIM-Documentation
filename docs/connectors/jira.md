...
| **API Token Type**             | Only when Jira is On-Demand                                                                              | Provide the Jira API token for the user specified in the User Email field. Use a Standard Token for general full access, or a Scoped Token for restricted access. For Scoped Tokens, refer to [API Token](#api-token) section to ensure the token has the required permissions. To know about the limitations of Scoped API Tokens, refer to [this](#known-limitations-2) section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
