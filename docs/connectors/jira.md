...
| **API Token Type**                    | Only when Jira is On-Demand                                                                              | Provide the Jira API token for the user specified in the User Email field. Use a Standard Token for general full access, or a Scoped Token for restricted access. For Scoped Tokens, refer this section for [ permissions guide ](https://docs.opshub.com/upcoming-release/connectors/jira#known-limitations-2) for Jira connector to ensure the token has the required permissions.                                                                                                                                                                                                                                                                                                                |
