...
Before you continue with the integration, you must first configure PagerDuty system onto <code class="expression">space.vars.OIM</code>.
...
| **API User Token**   | Always                                       | Add the User API token generated for the dedicated user for <code class="expression">space.vars.OIM</code>. Please refer to [How to Generate API token](#generateapitoken).   |
...
<p align="center">
  <img src="../assets/PagerDuty3.PNG" width="2000"/>
</p>
