...
## Enable <code class="expression">space.vars.OIM</code> for ServiceNow Quick Connect Instance

* <code class="expression">space.vars.OIM</code> must be enabled for the ServiceNow Express instance. You can get this app from ServiceNow appStore: [https://store.servicenow.com/sn _appstore _store.do#!/store/application/8e6f0b610f8ce6001f6fc3ace1050ebb](https://store.servicenow.com/sn_appstore_store.do#!/store/application/8e6f0b610f8ce6001f6fc3ace1050ebb)

<p align="center">
  <img src="../assets/Snow_Store.png" />
</p>

* On the <code class="expression">space.vars.OIM</code> App page, click on **Get** and provide your ServiceNow Quick Connect HI Credentials.
* You will see <code class="expression">space.vars.OIM</code> for ServiceNow Quick Connect in Downloads tab by navigating **System Applications -> Applications** in your ServiceNow Quick Connect instance  [The example below shows <code class="expression">space.vars.OIM</code> for ServiceNow Quick Connect Enterprise]. Click on Install for <code class="expression">space.vars.OIM</code> for ServiceNow Quick Connect applications.

<p align="center">
  <img src="../assets/Snow2.png" />
</p>

* On successful installation, <code class="expression">space.vars.OIM</code> for ServiceNow Quick Connect application will be available.
...
* All the fields of type reference i.e. the fields that refer to some other ServiceNow Quick Connect entity will be treated as look-ups in <code class="expression">space.vars.OIM</code>.
