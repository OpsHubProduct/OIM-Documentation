...
### Pre-requisites for User Impersonation

To enable user impersonation through  <code class="expression">space.vars.SITENAME</code> in Windchill PLM, certain configuration and access prerequisites must be completed before impersonation can function correctly. These prerequisites ensure that Windchill trusts requests coming from
<code class="expression">space.vars.SITENAME</code> and that the impersonated users have sufficient permissions to perform operations.

#### Configure OIM Host as a Trusted Host in Windchill PLM
...
* Identify the IP address of the machine where OIM is hosted. (Refer to [Verifying the IP Address of the OIM Host Machine](#verifying-the-ip-address-of-the-oim-host-machine))
...
#### Ensure Impersonated Users Have Required Permissions
...
| **Is impersonation required** | Optional                      | Select 'Yes' to enable user impersonation. By default, user impersonation will not be performed.                                                                                                                                                                                                                                                                                                                                                                                          |
...
## Mapping For User Impersonation
