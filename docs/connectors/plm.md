...
>**Note**: Entity support can be continuously enhanced, and additional Windchill PLM objects can be incorporated based on evolving business needs/priorities
---
...
```
* The following mappings were determined:
