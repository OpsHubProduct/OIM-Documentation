...
- **Field Search Limitations**:
    ...
    - When configuring criteria or target lookup for lookup-type fields, you must use the internal field values rather than display values. Display values will not work in these configurations.
