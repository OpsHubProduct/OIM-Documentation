...
* Create one user for Caliber RM System, dedicated to <code class="expression">space.vars.OIM</code>. User should not be used to do any other operations from System's User-Interface.
