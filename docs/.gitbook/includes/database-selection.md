...
- MSSQL with version 2012 :
  ...
  - The path to sqljdbc_10.2.0.0_enu.tar.gz is required while installing <code class="expression">visitor.claims.unsigned.product</code> with MSSQL database.
...
- MSSQL with version 2014 onwards:
  ...
  - The path to sqljdbc_12.2.0.0_enu.tar.gz is required while installing <code class="expression">visitor.claims.unsigned.product</code> with MSSQL database.
