...
- In the advanced installation, if <code class="expression">visitor.claims.unsigned.product</code> is going to be installed with the option of the [manual creation of the database](../../getting-started/installation.md#manual-creation-of-the-databases), then:
