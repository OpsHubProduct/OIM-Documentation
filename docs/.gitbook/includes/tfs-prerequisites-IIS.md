...
* **When TFS System is to be configured with 'Basic Authentication' in <code class="expression">visitor.claims.unsigned.product</code>**
...
* **When TFS System is to be configured with Personal Access Token in <code class="expression">visitor.claims.unsigned.product</code>**
