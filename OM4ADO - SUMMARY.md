  ...
  *  **Help Center**
      * FAQs
          * [General](docs/help-center/faqs/general-faqs.md)
            ...
            * [How to move application server from one machine to other?](docs/help-center/troubleshooting/faqs/general/move-application-server.md)  
            ...
            * [How to enable <code class="expression">space.vars.SITENAME</code> with HTTPS when it has already been installed with HTTP?](docs/help-center/faqs/general/enable-oim-with-https.md)  
            ...
            * [How to move <code class="expression">space.vars.SITENAME</code> from CentOS to Ubuntu?](docs/help-center/faqs/general/move-application-server.md)  
          ...
          * [Clarity](docs/help-center/faqs/clarity-faqs.md)
            * [Which authentication modes do <code class="expression">space.vars.SITENAME</code> support for Clarity?](docs/help-center/faqs/clarity/clarity-auth-types.md)  
          ...
          * [Micro Focus ALM/QC](docs/help-center/faqs/micro-focus-faqs.md)
            * [In an integration where Micro Focus ALM/QC is the source system, a specific field in the target system is not getting updated as per the updates in the source system](docs/help-center/faqs/microfocus/field-not-updated-hp-source.md)  
            * [Updated comment in Micro Focus ALM/QC is added as a new comment in the target system](docs/help-center/faqs/microfocus/present-comment-sync-to-target-system.md)  
            * [How to create a folder structure in Micro Focus QC/ALM based on the hierarchy in the source system?](docs/help-center/faqs/microfocus/folder-structure-on-information-from-source-system.md)  
            * [Requirement Traceability is not getting synchronized](docs/help-center/faqs/microfocus/requirement-traceability-is-not-getting-synchronized.md)  
            * [Design Steps are not getting synchronized](docs/help-center/faqs/microfocus/design-steps-are-not-getting-synchronized.md)  
            * [Getting error: "The Web server is configured to not list the contents of this directory" while accessing the proxy for Micro Focus QC/ALM](docs/help-center/faqs/microfocus/getting-error-the-web-server-is-configured-to-not-list-the-contents-of-this-directory-while-accessing-the-proxy-for-micro-focus-qcalm.md)  
            * [Getting error: "The requested content appears to be a script and will not be served by the static file handler" while accessing the proxy for Micro Focus QC/ALM](docs/help-center/faqs/microfocus/getting-error-the-requested-content-appears-to-be-script-and-will-not-be-served-by-the-static-file-handler-while-accessing-the-proxy-for-micro-focus.md)  
